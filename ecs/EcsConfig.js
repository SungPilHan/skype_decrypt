            ...
            ecsRequest.send().then(res => {
                if (res.statusCode === 200) {
                    ...
                    resolve({
                        ...
                        enableUwpCoexistenceCheck: result.SkypeElectronWrapper.enableUwpCoexistenceCheck || false,
                        ...
                        enableNewPresenceMode: result.SkypeElectronWrapper.enableNewPresenceMode || false
                    });
                }
