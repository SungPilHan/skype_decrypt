...
Prebuilt version of desktop-idle for skype use with electron. Uses @skype/ivy-downloader to fetch binaries in postinstall step.

To update version of desktop-idle binaries, you need to update postinstall script.
