...
Prebuild version of keytar for skype use with electron. Uses @skype/ivy-downloader to fetch binaries in postinstall step.

To update version of keytar binaries, you need to update postinstall script.
